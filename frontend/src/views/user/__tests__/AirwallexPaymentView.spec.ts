...
function airwallexSnapshot(overrides: Partial<PaymentRecoverySnapshot> = {}): PaymentRecoverySnapshot {
 ...
 payUrl: '/payment/airwallex?order_id=101&out_trade_no=nexus_awx_101&resume_token=resume-awx',
 outTradeNo: 'nexus_awx_101',
...
describe('AirwallexPaymentView', () => {
 ...
 expect(successUrl.searchParams.get('out_trade_no')).toBe('nexus_awx_101')
