<template>
 ...
 <div v-if="detail.attempted_key_prefix" class="rounded-lg bg-gray-50 p-4 ">
 ...
 <div v-if="detail.deleted_key_owner_email" class="rounded-lg bg-gray-50 p-4 ">
 ...
 <span v-if="detail.deleted_key_name" class="ml-1 text-xs text-gray-500 ">({{ detail.deleted_key_name }})</span>
 <span class="ml-2 inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-bold ring-1 ring-inset bg-red-50 text-red-700 ring-red-600/20 ">
