...
<template>
 ...
 <!-- 1) Health Score -->
 <div
 class="group relative flex cursor-pointer flex-col items-center justify-center rounded-lg py-2 transition-all hover:bg-white/60 md:border-r md:border-gray-200 md:pr-6 "
 >
