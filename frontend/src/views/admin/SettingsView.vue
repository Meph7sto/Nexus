          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
              ...
              <template v-if="form.payment_enabled">
                ...
                <!-- Row 4: Enabled payment types (provider badges like nexuspay) -->
                <div>
                  <label class="input-label">{{
...
.settings-tab-active {
  @apply border-primary-200/80 bg-white text-primary-700 shadow-sm dark:border-primary-400/30 dark:text-primary-200;
  box-shadow:
