<template>
 ...
 <div
 v-if="account"
 class="flex items-center justify-between rounded-lg border border-primary-200   p-3 "
 >
 ...
 <!-- 30-Day Total Cost -->
 <div
 class="card border-emerald-200   p-4 "
 >
 ...
 <div
 class="card border-blue-200   p-4 "
 >
 <div class="mb-2 flex items-center justify-between">
 <span class="text-xs font-medium text-gray-500 ">{{
 ...
 <!-- Daily Average Cost -->
 <div
 class="card border-amber-200   p-4 "
 >
 <div class="mb-2 flex items-center justify-between">
 <span class="text-xs font-medium text-gray-500 ">{{
 ...
 <div
 class="card border-purple-200   p-4 "
 >
 <div class="mb-2 flex items-center justify-between">
 <span class="text-xs font-medium text-gray-500 ">{{
