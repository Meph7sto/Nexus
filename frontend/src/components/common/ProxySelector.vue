...
.batch-test-btn {
 @apply flex-shrink-0 rounded p-1.5;
 @apply text-gray-500 hover:text-emerald-600 hover:bg-emerald-50;
...
.test-btn {
 ...
 @apply text-gray-400 hover:text-emerald-600 hover:bg-emerald-50;
 @apply transition-colors disabled:cursor-not-allowed disabled:opacity-50;
}
