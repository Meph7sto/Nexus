<template>
 <div
 class="flex items-center justify-between border-t border-[var(--nx-border)] bg-[var(--nx-surface)] px-4 py-3 sm:px-6"
 >
 ...
 :disabled="page === 1"
 class="pagination-button relative inline-flex items-center px-4 py-2"
 >
 ...
 class="pagination-button relative ml-3 inline-flex items-center px-4 py-2"
 >
 {{ t('pagination.next') }}
 </button>
 </div>
 ...
 <span class="text-sm text-[var(--nx-muted)]">{{ t('pagination.jumpTo') }}</span>
 <input
 v-model="jumpPage"
 type="number"
 min="1"
 ...
 <nav
 class="relative z-0 inline-flex -space-x-px rounded"
 ...
 @click="goToPage(page - 1)"
 :disabled="page === 1"
 class="pagination-button relative inline-flex items-center rounded-l px-2 py-2 text-[var(--nx-muted)]"
 ...
 pageNum === page
 ? 'z-10 border-[var(--nx-accent)] bg-[rgba(255,86,0,0.10)] text-[var(--nx-accent)]'
 : 'border-[var(--nx-border)] bg-[var(--nx-surface)] text-[var(--nx-text)] hover:bg-[var(--nx-bg)]',
 ...
 @click="goToPage(page + 1)"
 :disabled="page === totalPages"
 class="pagination-button relative inline-flex items-center rounded-r px-2 py-2 text-[var(--nx-muted)]"
