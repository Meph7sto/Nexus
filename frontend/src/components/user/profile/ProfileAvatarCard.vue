<template>
 ...
 ? 'flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-lg   text-xl font-bold text-white shadow-card shadow-primary-500/20'
 : 'flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-lg   text-3xl font-bold text-white shadow-card shadow-primary-500/20'"
 >
 <img
