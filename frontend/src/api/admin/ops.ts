...
const OPS_WS_BASE_PROTOCOL = 'nexus-admin'
...
export function subscribeQPS(onMessage: (data: any) => void, options: SubscribeQPSOptions = {}): () => void {
 ...
 // Sec-WebSocket-Protocol (subprotocol list): ["nexus-admin", "jwt.<token>"].
...
export interface OpsStorageUsageItem {
 ...
 status: OpsStorageUsageStatus | string
 error?: string
}
