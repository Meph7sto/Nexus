...
describe('ImportDataModal', () => {
 ...
 it('accepts Nexus data exports and rejects sub2api-branded exports', async () => {
 const { adminAPI } = await import('@/api/admin')
 ...
 vi.mocked(adminAPI.accounts.importData).mockClear()
 setInputFiles(input.element, [
 makeJsonFile(
 'sub2api.json',
 JSON.stringify({
