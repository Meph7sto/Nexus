...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		OpenAIAdvancedSchedulerLBTopK:                 strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerLBTopK, previousSettings.OpenAIAdvancedSchedulerLBTopK)),
		OpenAIAdvancedSchedulerWeightPriority:         strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightPriority, previousSettings.OpenAIAdvancedSchedulerWeightPriority)),
		OpenAIAdvancedSchedulerWeightLoad:             strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightLoad, previousSettings.OpenAIAdvancedSchedulerWeightLoad)),
		OpenAIAdvancedSchedulerWeightQueue:            strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightQueue, previousSettings.OpenAIAdvancedSchedulerWeightQueue)),
		OpenAIAdvancedSchedulerWeightErrorRate:        strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightErrorRate, previousSettings.OpenAIAdvancedSchedulerWeightErrorRate)),
		OpenAIAdvancedSchedulerWeightTTFT:             strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightTTFT, previousSettings.OpenAIAdvancedSchedulerWeightTTFT)),
		OpenAIAdvancedSchedulerWeightReset:            strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightReset, previousSettings.OpenAIAdvancedSchedulerWeightReset)),
		OpenAIAdvancedSchedulerWeightQuotaHeadroom:    strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightQuotaHeadroom, previousSettings.OpenAIAdvancedSchedulerWeightQuotaHeadroom)),
		OpenAIAdvancedSchedulerWeightPreviousResponse: strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightPreviousResponse, previousSettings.OpenAIAdvancedSchedulerWeightPreviousResponse)),
		OpenAIAdvancedSchedulerWeightSessionSticky:    strings.TrimSpace(stringSetting(req.OpenAIAdvancedSchedulerWeightSessionSticky, previousSettings.OpenAIAdvancedSchedulerWeightSessionSticky)),
