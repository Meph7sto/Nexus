...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["nexus-admin", "jwt.<token>"].
	// - We always select "nexus-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"nexus-admin"},
}
