...
import (
	...
	pkgerrors "github.com/Wei-Shaw/nexus/internal/pkg/errors"
	"github.com/Wei-Shaw/nexus/internal/pkg/geminicli"
	pkghttputil "github.com/Wei-Shaw/nexus/internal/pkg/httputil"
	"github.com/Wei-Shaw/nexus/internal/pkg/ip"
...
func (h *GatewayHandler) Messages(c *gin.Context) {
	...
	for {
		...
		for {
			...
			capture := service.BuildUsageInteractionCapture(attemptParsedReq.Body.Bytes(), result.ResponseBody, map[string]any{
