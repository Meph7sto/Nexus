...
func TestDetect_VersionGateCarriesVersionFields(t *testing.T) {
	...
	t.Run("version too low carries detected and minimum versions", func(t *testing.T) {
	...
	t.Run("version too high carries detected and maximum versions", func(t *testing.T) {
...
func TestCodexClientRestrictionMessage(t *testing.T) {
	...
	t.Run("undetectable version keeps generic message", func(t *testing.T) {
		msg := CodexClientRestrictionMessage(CodexClientRestrictionDetectionResult{
	...
	t.Run("unmatched client keeps generic message", func(t *testing.T) {
		msg := CodexClientRestrictionMessage(CodexClientRestrictionDetectionResult{
