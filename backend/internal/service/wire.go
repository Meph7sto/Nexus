...
func ProvideUpdateService(cache UpdateCache, releaseClient ReleaseClient, buildInfo BuildInfo) *UpdateService {
	return NewUpdateService(cache, releaseClient, buildInfo.Version, buildInfo.BuildType)
}
