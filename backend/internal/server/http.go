...
import (
	...
	"github.com/Wei-Shaw/nexus/internal/pkg/websearch"
...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, adminPerm, apiKeyAuth, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
